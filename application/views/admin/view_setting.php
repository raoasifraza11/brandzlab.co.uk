                        ...
                        <div class="tab-pane" id="tab_banner">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <?php echo form_close(); ?>
                                </tr>								 <tr>                                    <?php echo form_open_multipart(base_url().'admin/setting/update',array('class' => 'form-horizontal')); ?>                                        <td style="width:50%">                                            <h4>Existing Privacy Page Banner</h4>                                            <p>                                                <img src="<?php echo base_url().'public/uploads/'.$setting['banner_careers']; ?>" alt="" style="width: 100%;height:auto;">                                              </p>                                                                                </td>                                        <td style="width:50%">                                            <h4>Change Privacy Page Banner</h4>                                            Select Photo<input type="file" name="photo">                                            <input type="submit" class="btn btn-primary" value="Change" style="margin-top:10px;" name="form_banner_careers">                                        </td>                                    <?php echo form_close(); ?>                                </tr>
                            </table>
                        </div>
