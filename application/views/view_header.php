...
<head>
    ...
    if ($slug_arr[0] == 'careers') {
        echo '<meta name="description" content="' . $page['md_careers'] . '">';
        echo '<meta name="keywords" content="' . $page['mk_careers'] . '">';
        echo '<title>' . $page['mt_careers'] . '</title>';
    }
            ...
            <div class="col-md-3 col-sm-12">
                <div class="logo">
                    <a href="<?php echo base_url(); ?>"><img
                                src="<?php echo base_url(); ?>public/uploads/<?php echo $setting['logo']; ?>"
                                alt="Logo"></a>
                </div>
            </div>
